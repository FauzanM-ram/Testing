            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-gradient-primary topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                        ...
                        <div class="text-light font-weight-bold "style=" font-size: 24px;">Data Pelanggan</div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <a href="kelola_pelanggan.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Registrasi Pelanggan</a>
                    </div>
                            <!-- Circle Buttons -->
                        ...
                        <div class="card-header py-3">
                            ...
                            <form action="data_pelanggan.php" method="get">
                            <label>Cari :</label>
		                    ...
		                    <button type="submit" class="btn btn-sm btn-secondary " value="kembali">Kembali</button>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    if(isset($_GET['cari'])){
                                        $cari = $_GET['cari'];
                                        $query = mysqli_query($conn, "SELECT * FROM tb_customer WHERE id_cust LIKE '%".$cari."%' OR nama_cust LIKE '%".$cari."%' OR alamat LIKE '%".$cari."%'");	
                                    } else {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="kelola_pelanggan.php?ubah=<?php echo $result['id_cust']; ?>" type="button" class="btn btn-success btn-sm">
                                            <i class="fas fa-pencil-alt"></i> Edit
                                            </a>								
                                            <a href="proses.php?hapuspl=<?php echo $result['id_cust']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut???')">
