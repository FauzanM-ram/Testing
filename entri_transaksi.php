            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-gradient-primary topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                        ...
                        <div class="text-light font-weight-bold "style=" font-size: 24px;">Entri Transaksi</div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <a href="kelola_transaksi.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Tambah Data Entri</a>
                    </div>
                            <!-- Circle Buttons -->
                            <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold">Entri Transaksi</h6>
                        </div>
                            <div class="card-body">
                            <div class="table-responsive">
                            <form action="entri_transaksi.php" method="get">
                            <label>Cari :</label>
		                    ...
		                    <button type="submit" class="btn btn-sm btn-secondary " value="kembali">Kembali</button>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    if(isset($_GET['cari'])){
                                        $cari = $_GET['cari'];
                                        $query = mysqli_query($conn, "SELECT * FROM tb_transaksi WHERE no_faktur LIKE '%".$cari."%' OR status LIKE '%".$cari."%' OR dibayar LIKE '%".$cari."%' OR id_cust LIKE '%".$cari."%' ");	
                                    } else {
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo ++$no; ?>.</td>
                                            <td><?php echo $result['no_faktur']; ?></td>
                                            <td><?php echo $result['id_cust']; ?></td>
                                            <td><?php echo $result['tgl_masuk']; ?></td>
                                            <td><?php echo $result['batas_waktu']; ?></td>
                                            <td><?php echo $result['tgl_bayar']; ?></td>
                                            <td><?php echo $result['jumlah']; ?></td>
                                            <td><?php echo $result['harga']; ?></td>
                                            <td><?php echo $result['status']; ?></td>
                                            <td><?php echo $result['dibayar']; ?></td>
                                            <td><?php echo $result['id_user']; ?></td>
                                            <td><?php echo $result['jumlah_bayar']; ?></td>

                                            <td class="text-center"><a href="kelola_transaksi.php?ubah=<?php echo $result['no_faktur']; ?>" type="button" class="btn btn-success btn-sm">
                                            <i class="fas fa-pencil-alt"></i> Edit
                                            </a>								
                                            <a href="proses_transaksi.php?hapus=<?php echo $result['no_faktur']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut???')">
